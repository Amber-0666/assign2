...
<?php
// Only search database if there's a search term
if ($hasSearch) {
    ...
    if ($result->num_rows > 0) {
        ...
        echo '<p class="no-results">No products found matching "'.htmlspecialchars($search).'"</p>';
...
<!-- Original content shows when no search is performed -->
<?php if (!$hasSearch): ?>
